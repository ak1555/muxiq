...
//         children: [
//           ElevatedButton(
//             onPressed: Provider.of<AudioProvider>(context).pickSongs,
//             child: Text("Pick Songs from Storage"),
//           ),
//           Expanded(
//             child: ListView.builder(
//               itemCount: Provider.of<AudioProvider>(context).playlist.length,
//               itemBuilder: (context, index) {
//                 return ListTile(
//                   title: Text(Provider.of<AudioProvider>(context).playlist[index]),
//                 );
//               },
//             ),
//           ),
...
//                 onPressed: () => Provider.of<AudioProvider>(context).audioPlayer.play(),
//               ),
//               IconButton(
//                 icon: Icon(Icons.pause),
//                 onPressed: () => Provider.of<AudioProvider>(context).audioPlayer.pause(),
//               ),
//             ],
//           ),
//         ],
